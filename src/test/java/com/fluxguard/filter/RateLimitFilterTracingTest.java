...
class RateLimitFilterTracingTest {
    ...
    void setUp() {
        ...
        final PrometheusMetricsCollector collector = collector();
        final RateLimitEngine engine = new RateLimitEngine(
            mockExecutor, mockClock, circuitBreaker, collector, tracer);
        filter = new RateLimitFilter(
            engine, stubConfigService(), stubFlagService(), collector);
    }
