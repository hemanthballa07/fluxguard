...
public class PrometheusMetricsCollector {
    ...
    /**
     * Fail-open reason when a pre-decision Redis read (kill switch or per-endpoint
     * config lookup) failed. These reads are not guarded by the circuit breaker, so
     * this reason isolates lookup-path fail-opens from decision-path ones.
     */
    public static final String REASON_CONFIG_ERROR  = "config_lookup_error";
